            ...
            return {
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        var $this = $(this);
                        e.preventDefault();
                        window.location = '/searchPage/' + $this.find('.search-input').val();
                    });
                }
            };
        };
                        ...
                        if (!error) {
                            Login().postData('/bookReview', {
                                ...
                                if (result.result) {
                                    ...
                                    setTimeout(function () {
                                        $this.find('.Comments-successSend').text('');
                                        }, 2500);
                                } else {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/rateBookReview', data, function (result) {
                            if (result != null && result.result) {
                                ...
                                $this.parent().find('.Rating-title_error').text(result.error);
                                setTimeout(function () {
                                    $this.parent().find('.Rating-title_error').text('');
                                    }, 2500);
                            }
                        });
                    });
