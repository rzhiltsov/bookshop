                            ...
                            validate.forEach(function (v) {
                                switch (v) {
                                    case'require':
                                        ...
                                        break;
                                    case'password':
                                        if ($('#password').val() && $('#repeat_password').val() && $('#password').val() !== $('#repeat_password').val() && !$this.prop('disabled')) {
                                        ...
                                        else if ($this.val() && $('#password').val() === $('#repeat_password').val()) {
                                            $this = $('#repeat_password');
                                            buildMessage();
                                            $this = $(this);
                                        }
                ...
                init: function () {
                    ...
                    $Registration.on('submit', function(e) {
                        ...
                        if (!regButton.parent().find('.form-info').length) {
                            ...
                            var data = {name: $('#name').val(), password: $('#password').val(), phone: $('#phone').val(), mail: $('#mail').val()}
                            ...
                            redirect ? window.location.assign(redirect[1]) : window.location.assign('/my');
                        }
                    });
                    ...
                    $sendButton.on('click', function(e) {
                        ...
                        if (!error) {
                            ...
                            var contact = $thisStep.find('.form-input_phone, .form-input_mail').not('.form-input_hide').val();
                            postData('/login', {contact: contact, password: $('#password').val()}, function (result) {
                                    if (result.result) {
                                        var redirect = document.cookie.match('loginReferer=(.+);?');
                                        document.cookie = 'loginReferer=; max-age=0';
                                        redirect ? window.location.assign(redirect[1]) : window.location.assign('/my');
                                        ...
                                        $sendButton.next('.form-error').remove();
                                        $sendButton.after('<div class="form-error">' + result.error + '</div>');
                                    }
                            });
                        }
                    });
